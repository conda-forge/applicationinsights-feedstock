About applicationinsights-feedstock
===================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/applicationinsights-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6219&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/applicationinsights-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `applicationinsights` can be installed with `conda`:
...
```
mamba install applicationinsights
```

It is possible to list all of the versions of `applicationinsights` available on your platform with `conda`:
...
```
mamba search applicationinsights --channel conda-forge
```
...
mamba repoquery search applicationinsights --channel conda-forge

# List packages depending on `applicationinsights`:
mamba repoquery whoneeds applicationinsights --channel conda-forge

# List dependencies of `applicationinsights`:
mamba repoquery depends applicationinsights --channel conda-forge
```
